...
| customer_number  | VARCHAR(100)  | Alphanumeric identifier representing the customer, used for tracking and referencing.         |
| first_name       | VARCHAR(100)  | The customer's first name, as recorded in the system.                                         |
| last_name        | VARCHAR(100)  | The customer's last name or family name.                                                     |
...
| gender           | VARCHAR(10)  | The gender of the customer (e.g., 'Male', 'Female', 'n/a').                                  |
